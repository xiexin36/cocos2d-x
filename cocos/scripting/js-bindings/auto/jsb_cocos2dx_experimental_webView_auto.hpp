...
CC_JS_DLL void js_register_cocos2dx_experimental_webView_WebView(JSContext *cx, JS::HandleObject global);
CC_JS_DLL void register_all_cocos2dx_experimental_webView(JSContext* cx, JS::HandleObject obj);
